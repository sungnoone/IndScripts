...
//~ app.scriptArgs.set(  "startStr" , "<s-SubScript>" );
//~ app.scriptArgs.set(  "endStr" , "<e-SubScript>" );

var startStr = "_";//前標字串"<s-SubScript>"
var endStr = "";//後標字串"<e-SubScript>"
...
function Convert_SubScript(){
    ...
    with( findTextPrefs ){
        position = Position.SUBSCRIPT; // 下標字        
    }
